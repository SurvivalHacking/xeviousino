...
#define DAC_PRESENT  // commenta questa riga per utilizzare il Buzzer
...
/* custom hardware */
    ...
    #define TFT_WIDTH 240
    #define TFT_HEIGHT 240
    #define TFT_Y_OFFSET (320 - 240) // controller has wrong more memory than its size
...
#ifdef DAC_PRESENT
    /* --- OPZIONE 1: DAC I2S MAX98357A (commentare per disattivare) --- */
    #define HW_AUDIO
    #define HW_AUDIO_EXTDAC
...
#else
    /* --- OPZIONE 2: Buzzer PWM su GPIO 10 (decommentare per attivare) --- */
    #define HW_AUDIO_BUZZER
    #define HW_AUDIO_RESOLUTION_BITS 8
    #define HW_AUDIO_BUZZER_PIN 10
    #define HW_AUDIO_SAMPLERATE 22050  // buzzer usa 22050
#endif
    ...
    /* controller is PCF8574 I2C bus extender */
    #define HW_CONTROLLER_I2C_PCF8574
    #define HW_CONTROLLER_I2C_PCF8574_INT_PIN 15
    #define HW_CONTROLLER_I2C_PCF8574_ADDR 0x20
    ...
    #define TFT_WIDTH 240
    #define TFT_HEIGHT 240
    #define TFT_Y_OFFSET (320 - 240) // controller has more memory than its size
...
#elif defined(HW_WEMOS_S3_MINI)

    #ifdef FS_SPIFFS
    /* LittleFS (SPIFFS deprecato su ESP32-S3 core v3.x) */
    #define FILESYSTEM_BEGIN            \
        LittleFS.begin(false, FSROOT);  \
    ...
    #define HW_AUDIO
    #define HW_AUDIO_EXTDAC
    #define HW_AUDIO_EXTDAC_BCLK 33
    #define HW_AUDIO_EXTDAC_WCLK 37
    #define HW_AUDIO_EXTDAC_DOUT 38
    #define HW_AUDIO_SAMPLERATE 44100
#else
    /* --- OPZIONE 2: Buzzer PWM (decommentare per attivare) --- */
    #define HW_AUDIO_BUZZER
    #define HW_AUDIO_RESOLUTION_BITS 8
    #define HW_AUDIO_BUZZER_PIN 10
    #define HW_AUDIO_SAMPLERATE 22050
    ...
    /* I2C pins */
    #define HW_I2C_SDA 35
    #define HW_I2C_SCL 36
    ...
    #define TFT_WIDTH 240
    #define TFT_HEIGHT 240
    #define TFT_Y_OFFSET 0  // offset gestito dal costruttore ST7789 (row_offset1/2 = 80)

    /* Display initialisation
     * col_offset1=0, row_offset1=80, col_offset2=0, row_offset2=80
     * Necessari per ST7789 240x240: il controller ha 320 righe,
     * le righe fisiche visibili sono 80-319 (offset IPS = 80). */
    #define DISPLAY_INIT         \
        Arduino_DataBus *bus = new Arduino_ESP32SPI(TFT_DC /* DC */, TFT_CS /* CS */, TFT_SCK, TFT_MOSI, TFT_MISO); \
        Arduino_ST7789 *gfx = new Arduino_ST7789(bus, TFT_RES /* RST */, TFT_ROTATION /* rotation */, true /* IPS */, TFT_WIDTH, TFT_HEIGHT, 0, 80, 0, 80);
