...
#include "src/nofrendo/noftypes.h"

#include "src/nofrendo/event.h"
#include "src/nofrendo/gui.h"
#include "src/nofrendo/log.h"
#include "src/nofrendo/nes/nes.h"
#include "src/nofrendo/nes/nes_pal.h"
#include "src/nofrendo/nes/nesinput.h"
#include "src/nofrendo/nofconfig.h"
#include "src/nofrendo/osd.h"
...
extern void *mem_alloc(int size, bool prefer_fast_memory)
{
	...
	{
		// Prova RAM interna veloce; se non basta, usa SPIRAM come fallback
...
int osd_installtimer(int frequency, void *func, int funcsize, void *counter, int countersize)
{
	...
	timer = xTimerCreate("nes", (configTICK_RATE_HZ + frequency - 1) / frequency, pdTRUE, NULL, func);
	xTimerStart(timer, 0);
	return 0;
}
